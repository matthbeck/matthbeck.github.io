...
},
{
  ...
  "body": " Acknowledgements  We thank our students who made many suggestions for and found errors in the text. Special thanks go to Sheldon Axler, Collin Bleak, Pierre-Alexandre Bliman, Matthew Brin, Andrew Hwang, John McCleary, Sharma Pallekonda, Joshua Palmatier, and Dmytro Savchuk for comments, suggestions, and additions after teaching from this book.  We thank Lon Mitchell for his initiative and support for the print version of our book with Orthogonal Publishing, and Bob Chaffer for allowing us to feature his art on the book's cover (print version).  We are grateful to the American Institute of Mathematics for including our book in their Open Textbook Initiative .  "
},
{
  "id": "front-colophon",
  "level": "1",
...
},
{
  "id": "sec_mobius-11",
  "level": "2",
  "url": "sec_mobius.html#sec_mobius-11",
  "type": "Proof",
  "number": "3.1.1",
  "title": "",
...
},
{
  "id": "sec_mobius-15",
  "level": "2",
  "url": "sec_mobius.html#sec_mobius-15",
  "type": "Proof",
  "number": "3.1.2",
  "title": "",
  "body": " Simplify.  "
...
},
{
  ...
  "number": "8.3.4",
  "title": "",
  "body": "  We'd like to compute the start of a Laurent series for centered at . We start by considering the function defined by   A quick application of L'Hôpital's Rule (lhospital) shows that is continuous (see ). Even better, another round of L'Hôpital's Rule proves that .  But this means that in particular, is holomorphic in . This is a (simple) example of analytic continuation : the function is holomorphic in and agrees with in , the domain in which the latter function is holomorphic. When we said, in , that the Riemann zeta function can be extended to a function that is holomorphic on , we were also talking about analytic continuation. By , has a power series expansion at 0, which we may compute using . It starts with and it converges, by , for . But this gives our sought-after Laurent series which converges for .   "
},
{
