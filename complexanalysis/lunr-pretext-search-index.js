...
},
{
  ...
  "number": "1.6",
  "title": "Optional Lab",
  "body": " Optional Lab    Convert the following complex numbers into their polar representation, i.e., give the absolute value and the argument of the number.  After you have finished computing these numbers, check your answers with SageMath .    Convert the following complex numbers given in polar representation into their rectangular representation.  After you have finished computing these numbers, check your answers with SageMath .    Pick your favorite five numbers , , , , and from the ones that you've played around with and put them in the table below, in both rectangular and polar form. Apply the functions listed to your numbers. Think about which representation is more helpful in each instance.                   rectangular         polar                                                                                                                                    Play with other examples until you get a feel for these functions.     "
},
{
  ...
  "number": "1.6.1",
  "title": "",
  "body": " Convert the following complex numbers into their polar representation, i.e., give the absolute value and the argument of the number.  After you have finished computing these numbers, check your answers with SageMath .  "
},
{
  ...
  "number": "1.6.2",
  "title": "",
  "body": " Convert the following complex numbers given in polar representation into their rectangular representation.  After you have finished computing these numbers, check your answers with SageMath .  "
},
{
...
{
  "id": "sec_defharmonic-17",
  "level": "2",
  "url": "sec_defharmonic.html#sec_defharmonic-17",
  "type": "Example",
  "number": "6.1.8",
  "title": "",
...
{
  "id": "sec_defharmonic-22",
  "level": "2",
  "url": "sec_defharmonic.html#sec_defharmonic-22",
  "type": "Proof",
  "number": "6.1.2",
  "title": "",
...
},
{
  ...
  "number": "7.2.17",
  "title": "",
  "body": "  Continuing , converges for , because then (using ) converges. Viewed as a function in , the series is the Riemann zeta function , an indispensable tool in number theory and many other Riemann zeta function areas in mathematics and physics. The Riemann zeta function is the subject of the arguably most famous open problem in mathematics, the Riemann hypothesis . It turns out that can be extended to a function that is holomorphic on , and the Riemann hypothesis asserts that the roots of this extended function in the strip are all on the critical line  .    "
},
{
  "id": "ex_altharmonic",
  "level": "2",
