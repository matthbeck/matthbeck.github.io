...
},
{
  ...
  "number": "1",
  "title": "Introduction",
  "body": " Introduction  The mathematics of musical scales and, by extension, intervals between two notes has been extensively studied (see, e.g., for two recent papers). A key feature of an interval is the frequency ratio between the two notes. Vastly simplified (and one has to be careful, for various reasons), our ears seem to prefer simple ratios, such as (octave), (perfect fifth), (perfect forth), etc. See, e.g., for relevant background.  Likewise, there is much literature on the mathematics of musical chords giving, e.g., interesting group-theoretic connections, both in music theory (see, e.g., ) and algebra (see, e.g., ). These tend to concern movements in a given musical piece, such as transpositions and inversions. It is a short step to model, say, a twelve-note scale as (see Figure ), and so these mathematical aspects of chords are independent of the actual frequency ratios of the scale.   My favorite depiction of . [Figure credit: Wikimedia Commons, Piano-full-en.svg]    But why do we perceive, say, a major triad as more pleasant than a chord consisting of three notes separated by two half tones? One could make an argument that the appreciation of chords is to a large extend culturally based. On the other hand, acoustics (see, e.g., ) offers some explanations, e.g., by looking at the wave forms of chords containing a perfect forth. (Many piano tuners start with forths for the same reason, though they listen for beats in order to achieve an equal-tempered scale.) This gives rise to much interesting mathematics (see, e.g., ) and statistics (see, e.g., ). However, the mathemusical literature seems to contain few studies on musical chords in analogy with the afore-mentioned simple-fractions intervals. Our aim is to develop a mathematical model that might fill some of these gaps.  Capturing a numerical value of a given chord relies on fixing a scale, and different scales will yield different numerics. We will develop a model and then try it out on different scales; all of them will be just scales , i.e., ones with simple Here simple refers to fractions whose numerator and denominator are not too large. We will have more to say about this later. rational frequency ratio (as opposed to, e.g., the equal-tempered 12-note scale, in which each interval has a frequency ratio equal to a power of ; see for a mathematical interplay between just and equal-temperament scales). It is this feature that will allow us to study chords from an basic mathematical perspective.  Like most (all?) mathematical texts on musical subjects, we stress that we have no intention to capture, much less understand, the way different chords feel this is (way) beyond any arithmetic nature, not to mention the rich music theory that gets much closer to this issue. Along similar lines, we also clarify from the start that our model does not constitute any absolute measure: some features will seem arbitrary, and we feel that this is fine. The findings we offer are most definitely in the ears of the beholder, and we merely invite the reader to come up with their own interpretation of the mathematics behind chords presented here.  "
},
{
  "id": "fig_pianokeys",
  "level": "2",
  "url": "sec_intro.html#fig_pianokeys",
  "type": "Figure",
  "number": "1.1",
  "title": "",
...
},
{
  "id": "fig_equclasses",
  "level": "2",
  "url": "sec_equassumptions.html#fig_equclasses",
  "type": "Figure",
  "number": "2.2",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec_intfractions.html#tab_classicjustscaleintfractions",
  "type": "Table",
  "number": "3.2",
...
},
{
  ...
  "level": "2",
  "url": "sec_intfractions.html#table_classicjustscaleprimecomplexity",
  "type": "Table",
  "number": "3.3",
...
},
{
  ...
  "level": "2",
  "url": "sec_intfractions.html#fig_classicwinners",
  "type": "Figure",
  "number": "3.4",
  "title": "",
...
},
{
  ...
  "number": "",
  "title": "Bibliography",
  "body": " Bibliography  J.~Murray Barbour, \\emph{Tuning and {T}emperament: A {H}istorical {S}urvey}, Michigan State College Press, East Lansing, 1951.  Dave Benson, \\emph{Music: {A} {M}athematical {O}ffering}, Cambridge University Press, 2007.  George~D. Birkhoff, \\emph{Aesthetic {M}easure}, {Harvard} {University} {Press}, 1933.  Jeffrey~R. Boland and Lane~P. Hughston, \\emph{Mathematical foundations of complex tonality}, J. Math. Music \\textbf{18} (2024), no.~2, 173--202.  Emily Clader, \\emph{Why twelve tones? {The} mathematics of musical tuning}, Math. Intell. \\textbf{40} (2018), no.~3, 32--36.  Alissa~S. Crans, Thomas~M. Fiore, and Ramon Satyendra, \\emph{Musical actions of dihedral groups}, Amer. Math. Monthly \\textbf{116} (2009), no.~6, 479--495.  Rafael Cubarsi, \\emph{Harmonic distance in intervals and chords}, J. Math. Music \\textbf{13} (2019), no.~1, 85--106.  Tuomas Eerola and Imre Lahdelma, \\emph{The anatomy of consonance\/dissonance: Evaluating acoustic and cultural predictors across multiple datasets with chords}, Music & Science \\textbf{4} (2021), 1--19.  Donald~E. Hall, \\emph{Musical {A}coustics}, Brooks\/Cole Publishing Company, 1991.  Isabella Masina and Giuseppe~Lo Presti, \\emph{Triad's consonance and dissonance: combining roughness and compactness models}, Eur. Phys. J. Plus (2024), 139:79.  Robert Morris, \\emph{Mathematics and the twelve-tone system: past, present, and future}, Mathematics and computation in music. First international conference, MCM 2007, Berlin, Germany, May 18--20, 2007. Revised Selected Papers, Berlin: Springer, 2009, pp.~266--288.  Jordan Schettler, \\emph{Wendy {Carlos}'s xenharmonic keyboard}, Math. Mag. \\textbf{92} (2019), no.~3, 201--212.  Dmitri Tymoczko, \\emph{The geometry of musical chords}, Science \\textbf{313} (2006), no.~5783, 72--74.  James~S. Walker and Gary~W. Don, \\emph{Mathematics and {M}usic. {Composition}, {P}erception, and {P}erformance}, 2nd edition ed., Boca Raton, FL: CRC Press, 2020.  "
}
]
